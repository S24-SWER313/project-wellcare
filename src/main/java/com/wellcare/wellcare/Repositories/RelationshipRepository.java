...
public interface RelationshipRepository extends JpaRepository<Relationship, Long> {
    ...
    List<Relationship> findAllByUserOneIdAndStatusOrUserTwoIdAndStatus(Long id1, int status1, Long id2, int status2);
    ...
    Relationship findRelationshipWithFriendWithStatus(@Param("userOneId") Long userOneId, @Param("userTwoId") Long userTwoId, @Param("status") int status);
